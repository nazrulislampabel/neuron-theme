...
class MySocialIcons_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'My: Social Icons', 'philosophy' ), // Name
...
function My_social_icons_widget() {
    register_widget( 'MySocialIcons_Widget' );
}

add_action( 'widgets_init', 'My_social_icons_widget' );
